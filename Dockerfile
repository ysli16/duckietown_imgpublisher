# parameters
ARG REPO_NAME="<duckietown_imgpublisher>"
ARG DESCRIPTION="<ROS node to extract image from NVIDIA Jetson Nano camera and pubish it to a topic. For AMoD RH3 exercise 21.>"
